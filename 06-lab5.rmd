# Regression and Time Series {#lab5}
...
```{r imageoutput, out.width='95%', fig.asp=.75, echo = FALSE, fig.align = "center"}
knitr::include_graphics("im_05_01.png")
```
...
```{r objectzoom, out.width='50%', fig.asp=.75, echo = FALSE, fig.align = "center"}
knitr::include_graphics("im_05_02.png")
```
...
```{r ndvitimeseries, out.width='95%', fig.asp=.75, echo = FALSE, fig.align = "center"}
knitr::include_graphics("im_05_03.png")
```
