...
{\centering \includegraphics[width=0.95\linewidth]{spectral_indices_lab3} 

}

\caption{Sample Spectral Reflectance Curves}(\#fig:specindices)
\end{figure}
...
{\centering \includegraphics[width=0.95\linewidth]{tassel_cap_lab3} 

}

\caption{Tassel Cap Illustration}(\#fig:tasselcap)
\end{figure}
...
{\centering \includegraphics[width=0.95\linewidth]{spectral_chart_lab3} 

}

\caption{Spectral Chart}(\#fig:spectralchartlab3)
\end{figure}
