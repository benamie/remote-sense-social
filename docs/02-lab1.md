...
\caption{Digital Image Example}(\#fig:digimage)
\end{figure}
...
\caption{A pixel, raster, and a CRS}(\#fig:pixel)
\end{figure}
...
\caption{Common Optical Sensors and their Spectral Resolution}(\#fig:spectralres)
\end{figure}
