...
knitr::include_graphics("clip_image003.png")
...
```{r pixel, fig.cap='A pixel, raster, and a CRS', out.width='80%', fig.asp=.75, echo = FALSE, fig.align = "center"}

knitr::include_graphics("clip_image002.png")
```
...
```{r spectralres, fig.cap='Common Optical Sensors and their Spectral Resolution', out.width='100%', fig.asp=.75, echo = FALSE, fig.align = "center"}

knitr::include_graphics("common_optical_sensors_spectral_resolution.png")
