...
```{r sfgeeexample, fig.cap='Playground Search for San Francisco in the GEE Console', out.width='95%', fig.asp=.75, echo = FALSE, fig.align = "center"}

knitr::include_graphics("sf_gee_example.png")
...
```{r irradiancewavelength, fig.cap ='Solar irradiance. Data sources: 6000K blackbody spectrum from http://astrogeology.usgs.gov/tools/thermal-radiance-calculator, adjusted according to the solid angle subtended by the solar disk. TOA and sea level irradiance from http://rredc.nrel.gov/solar/spectra/am1.5/', out.width='100%', fig.asp=.75, echo = FALSE, fig.align = "center"}

knitr::include_graphics("irradiance_wavelength.png")
```


<!-- **Figure 1**. Solar irradiance. Data sources: 6000K blackbody spectrum from http://astrogeology.usgs.gov/tools/thermal-radiance-calculator, adjusted according to the solid angle subtended by the solar disk. TOA and sea level irradiance from http://rredc.nrel.gov/solar/spectra/am1.5/.  -->
